...
public class AuthenticationClient {
    ...
    /**
     * Make a call to the authenticate operation to get a session identifier. Return the session identifier
     * and also store it in the member variable (session_identifier). 
     * 
     * The SESSION_MAINTAIN_PROPERTY of the requestContext of the binding provider/port must set to 
     * Boolean.TRUE in order to send, receive and store cookies. This only needs to be done once for 
    ...
    public String getSessionIdentifier() throws Exception
    {
        try {
             ...
             */
            //context.put(javax.xml.ws.BindingProvider.SESSION_MAINTAIN_PROPERTY, Boolean.valueOf(true));
            /* comment end */
            ...
            //  бн finish your exception handling, 
     ...
     * 
     * The session identifier is sent as an HTTP cookie with name "SID". The value of the cookie is the 
     * session identifier. This cookie is already set in the requestContext for this binding provider/port
    ...
    public void closeSession() throws Exception { 
      try { 
          /*
           * comment start: 
           * the next three lines of code have already been done for this port in createPort()
           * otherwise the SESSION_MAINTAIN_PROPERTY needs to be set to Boolean.TRUE
           */
          //BindingProvider bp = (BindingProvider)port;
          //Map<String, Object> context = bp.getRequestContext();
     ...
     * 
     * Once this is done the session cookie will be set for all outgoing requests from this port.
     * 
     * @throws Exception
     */
    ...
    public static void main(String[] args) throws Exception
    {
         ...
         * make the session identifier available to all other Web service operations within
         * this service port
        */
