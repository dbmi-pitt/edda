...
import gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Citation;
...
public class Entrez
{
  private static EUtilsServiceSoapProxy service;
  private static ESearchRequest req;

  public Entrez() throws Exception 
  {
    service = new EUtilsServiceSoapProxy();
    req = new ESearchRequest();
  }
