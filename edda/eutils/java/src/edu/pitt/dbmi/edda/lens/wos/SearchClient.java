package edu.pitt.dbmi.edda.lens.wos;
...
/**
 * A very simple high-level client program to access the WokSearchLite Web service. 
 * The search operation is called. 
 * 
 * The very simple high-level AuthenticationClient is also used to create an ISI WOK WS session 
 * identifier and to close the session when we are finished. 
 * 
 * This client program also illustrates two different ways to create the WokSearchLite port/client. 
 * The first {@link #createPort(URL)} uses standard JAX-WS APIs. 
 * The second {@link #createPortUsingFactory()} 
 * uses a CXF Factory that provides more control.  
 * 
 * There are even more ways to create the port available. Refer to the JAX-WS API documentation. 
 */
public class SearchClient {
    ...
    /**
     * Create the port for WokSearchLite Web service using the WokSearchLiteService class. 
     * 
     * @param wsdlURL the url of the WSDL
     * 
     * @return the port (e.g. instance of the WokSearchLite interface) for the WokSearchLite Web service
     * 
     * @throws Exception
     */
    ...
    /**
     * Create the port for WokSearchLite Web service using a JAX-WS factory class and the 
    ...
    public static WokSearchLite createPortUsingFactory( ) throws Exception {
        try { 
            /*
             * comment start: 
             * CXF Factory for creating JAX-WS Proxies. This class provides access to internal  
    ...
    public static void setSessionCookie( WokSearchLite port, String sid ) throws Exception { 
         ...
         * output HTTP message.
         * 
         * if you are using createPort() method then uncomment the following two lines.
    ...
    public static void main(String args[]) throws Exception {
        ...
        //auth.createPort( new URL( AuthenticationClient.REMOTE_WSDL_URL ) );  // use remote WSDL
        auth.createPort( AuthenticationClient.LOCAL_WSDL_URL );  // use local  WSDL
        ...
        try {
            ...
            System.out.println("search.result.getRecordsFound()=" + _search__return.getRecordsFound());
