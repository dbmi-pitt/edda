...
public class KwdGroup  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Kwd kwd;

    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.X x;

    private java.lang.String id;  // attribute

    private java.lang.Object kwdGroupType;  // attribute
    ...
    public KwdGroup(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Kwd kwd,
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.X x,
           java.lang.String id,
           java.lang.Object kwdGroupType) {
           this.title = title;
           this.kwd = kwd;
           this.x = x;
           this.id = id;
     ...
     * @return kwd
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Kwd getKwd() {
        return kwd;
    }
     ...
     * @param kwd
     */
    public void setKwd(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Kwd kwd) {
        this.kwd = kwd;
    }
     ...
     * @return kwdGroupType
     */
    public java.lang.Object getKwdGroupType() {
        return kwdGroupType;
    }
     ...
     * @param kwdGroupType
     */
    public void setKwdGroupType(java.lang.Object kwdGroupType) {
        this.kwdGroupType = kwdGroupType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">kwd-group"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "kwd"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">kwd"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
