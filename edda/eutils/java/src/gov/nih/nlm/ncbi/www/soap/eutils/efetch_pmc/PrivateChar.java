...
public class PrivateChar  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphData glyphData;

    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphRef glyphRef;

    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.InlineGraphic[] inlineGraphic;

    private java.lang.Object description;  // attribute

    private java.lang.Object name;  // attribute

    public PrivateChar() {
    }

    public PrivateChar(
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphData glyphData,
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphRef glyphRef,
     ...
     * @return glyphData
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphData getGlyphData() {
        return glyphData;
    }
     ...
     * @param glyphData
     */
    public void setGlyphData(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphData glyphData) {
        this.glyphData = glyphData;
    }
     ...
     * @return glyphRef
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphRef getGlyphRef() {
        return glyphRef;
    }
     ...
     * @param glyphRef
     */
    public void setGlyphRef(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlyphRef glyphRef) {
        this.glyphRef = glyphRef;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">private-char"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "glyph-data"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">glyph-data"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("glyphRef");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "glyph-ref"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">glyph-ref"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
