...
public class ArticleCategories  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesTitle[] seriesTitle;

    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesText seriesText;
    ...
    public ArticleCategories(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesTitle[] seriesTitle,
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesText seriesText) {
     ...
     * @return seriesTitle
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesTitle[] getSeriesTitle() {
        return seriesTitle;
    }
     ...
     * @param seriesTitle
     */
    public void setSeriesTitle(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesTitle[] seriesTitle) {
        this.seriesTitle = seriesTitle;
    }

    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesTitle getSeriesTitle(int i) {
        return this.seriesTitle[i];
    }

    public void setSeriesTitle(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesTitle _value) {
     ...
     * @return seriesText
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesText getSeriesText() {
        return seriesText;
    }
     ...
     * @param seriesText
     */
    public void setSeriesText(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.SeriesText seriesText) {
        this.seriesText = seriesText;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">article-categories"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "series-title"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "series-title"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "series-text"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">series-text"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
