...
public class EUtilsServiceSoapStub extends org.apache.axis.client.Stub implements gov.nih.nlm.ncbi.www.soap.eutils.EUtilsServiceSoap {
    ...
    public EUtilsServiceSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", ">IconUrlType>LNG");
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.www.soap.eutils.elink.IconUrlTypeLNG.class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", ">UrlType>LNG");
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.www.soap.eutils.elink.UrlTypeLNG.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "FirstCharsType");
            cachedSerQNames.add(qName);
            cls = java.lang.String[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "FirstChar");
            qName2 = null;
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "IconUrlType");
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.www.soap.eutils.elink.IconUrlType.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.www.soap.eutils.elink.IdLinkSetType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "LinkSetDbHistoryType");
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetDbHistoryType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "UrlType");
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.www.soap.eutils.elink.UrlType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            cachedDeserFactories.add(org.apache.axis.encoding.ser.BaseDeserializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleDeserializerFactory.class, cls, qName));
