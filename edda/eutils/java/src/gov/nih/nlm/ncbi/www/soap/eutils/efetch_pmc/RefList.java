...
public class RefList  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Ref[] ref;
    ...
    public RefList(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Ref[] ref,
    ...
    /**
     * Gets the math value for this RefList.
     * 
     * @return math
     */
    ...
    /**
     * Sets the math value for this RefList.
     * 
     * @param math
     */
    ...
    /**
     * Gets the x value for this RefList.
     * 
     * @return x
     */
    ...
    /**
     * Sets the x value for this RefList.
     * 
     * @param x
     */
     ...
     * @return ref
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Ref[] getRef() {
        return ref;
    }
     ...
     * @param ref
     */
    public void setRef(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Ref[] ref) {
        this.ref = ref;
    }

    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Ref getRef(int i) {
        return this.ref[i];
    }

    public void setRef(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Ref _value) {
        this.ref[i] = _value;
    }
    ...
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.RefList getRefList(int i) {
        return this.refList[i];
    }

    public void setRefList(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.RefList _value) {
        this.refList[i] = _value;
    }


    /**
     * Gets the id value for this RefList.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this RefList.
     * 
     * @param id
     */
    ...
    /**
     * Gets the contentType value for this RefList.
     * 
     * @return contentType
     */
    ...
    /**
     * Sets the contentType value for this RefList.
     * 
     * @param contentType
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">ref-list"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "ref"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "ref"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
