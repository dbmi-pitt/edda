...
public class TableWrapGroup  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.TableWrapGroupPosition position;  // attribute
    ...
    public TableWrapGroup(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.TableWrapGroupPosition position) {
           this.label = label;
    ...
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.TableWrap getTableWrap(int i) {
        return this.tableWrap[i];
    }

    public void setTableWrap(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.TableWrap _value) {
    ...
    /**
     * Gets the contentType value for this TableWrapGroup.
     * 
     * @return contentType
     */
    ...
    /**
     * Sets the contentType value for this TableWrapGroup.
     * 
     * @param contentType
     */
     ...
     * @return position
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.TableWrapGroupPosition getPosition() {
        return position;
    }
     ...
     * @param position
     */
    public void setPosition(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.TableWrapGroupPosition position) {
        this.position = position;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">table-wrap-group"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">>table-wrap-group>position"));
        typeDesc.addFieldDesc(attrField);
