...
public class GlyphRef  implements java.io.Serializable {
    private java.lang.String glyphData;  // attribute

    public GlyphRef() {
    }

    public GlyphRef(
           java.lang.String glyphData) {
     ...
     * @return glyphData
     */
    public java.lang.String getGlyphData() {
        return glyphData;
    }
     ...
     * @param glyphData
     */
    public void setGlyphData(java.lang.String glyphData) {
        this.glyphData = glyphData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">glyph-ref"));
