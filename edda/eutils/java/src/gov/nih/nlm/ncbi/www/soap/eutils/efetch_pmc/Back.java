...
public class Back  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AppGroup appGroup;
    ...
    public Back(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AppGroup appGroup,
    ...
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Title getTitle(int i) {
        return this.title[i];
    }

    public void setTitle(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Title _value) {
        this.title[i] = _value;
    }
     ...
     * @return appGroup
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AppGroup getAppGroup() {
        return appGroup;
    }
     ...
     * @param appGroup
     */
    public void setAppGroup(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AppGroup appGroup) {
        this.appGroup = appGroup;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">back"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "app-group"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">app-group"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
