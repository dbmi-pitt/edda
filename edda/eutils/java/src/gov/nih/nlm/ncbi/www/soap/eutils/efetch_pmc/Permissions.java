...
public class Permissions  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.CopyrightHolder copyrightHolder;
    ...
    public Permissions(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.CopyrightHolder copyrightHolder,
     ...
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.CopyrightHolder getCopyrightHolder() {
        return copyrightHolder;
    }
     ...
     */
    public void setCopyrightHolder(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.CopyrightHolder copyrightHolder) {
        this.copyrightHolder = copyrightHolder;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">permissions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "copyright-holder"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">copyright-holder"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
