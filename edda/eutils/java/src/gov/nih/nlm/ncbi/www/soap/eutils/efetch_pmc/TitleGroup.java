...
public class TitleGroup  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AltTitle[] altTitle;
    ...
    public TitleGroup(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AltTitle[] altTitle,
    ...
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Subtitle getSubtitle(int i) {
        return this.subtitle[i];
    }

    public void setSubtitle(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Subtitle _value) {
     ...
     * @return altTitle
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AltTitle[] getAltTitle() {
        return altTitle;
    }
     ...
     * @param altTitle
     */
    public void setAltTitle(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AltTitle[] altTitle) {
        this.altTitle = altTitle;
    }

    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AltTitle getAltTitle(int i) {
        return this.altTitle[i];
    }

    public void setAltTitle(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.AltTitle _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">title-group"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "alt-title"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "alt-title"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
