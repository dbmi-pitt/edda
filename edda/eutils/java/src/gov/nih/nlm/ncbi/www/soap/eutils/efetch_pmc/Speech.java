...
public class Speech  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Speaker speaker;
    ...
    public Speech(
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Speaker speaker,
     ...
     * @return speaker
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Speaker getSpeaker() {
        return speaker;
    }
     ...
     * @param speaker
     */
    public void setSpeaker(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.Speaker speaker) {
        this.speaker = speaker;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">speech"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "speaker"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">speaker"));
