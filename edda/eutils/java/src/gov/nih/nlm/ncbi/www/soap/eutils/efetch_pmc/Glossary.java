...
public class Glossary  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlossGroup[] glossGroup;
    ...
    public Glossary(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlossGroup[] glossGroup,
           java.lang.String id,
    ...
    /**
     * Gets the math value for this Glossary.
     * 
     * @return math
     */
    ...
    /**
     * Sets the math value for this Glossary.
     * 
     * @param math
     */
    ...
    /**
     * Gets the x value for this Glossary.
     * 
     * @return x
     */
    ...
    /**
     * Sets the x value for this Glossary.
     * 
     * @param x
     */
     ...
     * @return glossGroup
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlossGroup[] getGlossGroup() {
        return glossGroup;
    }
     ...
     * @param glossGroup
     */
    public void setGlossGroup(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlossGroup[] glossGroup) {
        this.glossGroup = glossGroup;
    }

    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlossGroup getGlossGroup(int i) {
        return this.glossGroup[i];
    }

    public void setGlossGroup(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.GlossGroup _value) {
    ...
    /**
     * Gets the contentType value for this Glossary.
     * 
     * @return contentType
     */
    ...
    /**
     * Sets the contentType value for this Glossary.
     * 
     * @param contentType
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">glossary"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "gloss-group"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", "gloss-group"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
