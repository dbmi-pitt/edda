...
public class FigGroup  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.FigGroupPosition position;  // attribute
    ...
    public FigGroup(
           ...
           java.lang.String id,
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.FigGroupPosition position,
     ...
     * @return position
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.FigGroupPosition getPosition() {
        return position;
    }
     ...
     * @param position
     */
    public void setPosition(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pmc.FigGroupPosition position) {
        this.position = position;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">fig-group"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">>fig-group>position"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
