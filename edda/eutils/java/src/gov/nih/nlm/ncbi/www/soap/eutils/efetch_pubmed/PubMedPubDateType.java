...
public class PubMedPubDateType  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.PubMedPubDateTypePubStatus pubStatus;  // attribute
    ...
    public PubMedPubDateType(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.PubMedPubDateTypePubStatus pubStatus) {
           this.year = year;
           this.month = month;
           this.day = day;
           this.hour = hour;
     ...
     * @return pubStatus
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.PubMedPubDateTypePubStatus getPubStatus() {
        return pubStatus;
    }
     ...
     * @param pubStatus
     */
    public void setPubStatus(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.PubMedPubDateTypePubStatus pubStatus) {
        this.pubStatus = pubStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", "PubMedPubDateType"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("pubStatus");
        attrField.setXmlName(new javax.xml.namespace.QName("", "PubStatus"));
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", ">PubMedPubDateType>PubStatus"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", "Hour"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("minute");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", "Minute"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("second");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", "Second"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
