...
public class JournalIssueType  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.JournalIssueTypeCitedMedium citedMedium;  // attribute
    ...
    public JournalIssueType(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.JournalIssueTypeCitedMedium citedMedium) {
           this.volume = volume;
           this.issue = issue;
     ...
     * @return citedMedium
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.JournalIssueTypeCitedMedium getCitedMedium() {
        return citedMedium;
    }
     ...
     * @param citedMedium
     */
    public void setCitedMedium(gov.nih.nlm.ncbi.www.soap.eutils.efetch_pubmed.JournalIssueTypeCitedMedium citedMedium) {
        this.citedMedium = citedMedium;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", "JournalIssueType"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("citedMedium");
        attrField.setXmlName(new javax.xml.namespace.QName("", "CitedMedium"));
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", ">JournalIssueType>CitedMedium"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pubmed", "Issue"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
