...
public class P  implements java.io.Serializable, org.apache.axis.encoding.MixedContentType {
    ...
    /**
     * Gets the sansSerif value for this P.
     * 
     * @return sansSerif
     */
    ...
    /**
     * Sets the sansSerif value for this P.
     * 
     * @param sansSerif
     */
    ...
    /**
     * Gets the math value for this P.
     * 
     * @return math
     */
    ...
    /**
     * Sets the math value for this P.
     * 
     * @param math
     */
    ...
    /**
     * Gets the milestoneEnd value for this P.
     * 
     * @return milestoneEnd
     */
    ...
    /**
     * Sets the milestoneEnd value for this P.
     * 
     * @param milestoneEnd
     */
    ...
    /**
     * Gets the milestoneStart value for this P.
     * 
    ...
    /**
     * Sets the milestoneStart value for this P.
     * 
    ...
    /**
     * Gets the nlmCitation value for this P.
     * 
     * @return nlmCitation
     */
    ...
    /**
     * Sets the nlmCitation value for this P.
     * 
     * @param nlmCitation
     */
    ...
    /**
     * Gets the contractNum value for this P.
     * 
     * @return contractNum
     */
    ...
    /**
     * Sets the contractNum value for this P.
     * 
     * @param contractNum
     */
    ...
    /**
     * Gets the contractSponsor value for this P.
     * 
    ...
    /**
     * Sets the contractSponsor value for this P.
     * 
    ...
    /**
     * Gets the grantNum value for this P.
     * 
     * @return grantNum
     */
    ...
    /**
     * Sets the grantNum value for this P.
     * 
     * @param grantNum
     */
    ...
    /**
     * Gets the grantSponsor value for this P.
     * 
     * @return grantSponsor
     */
    ...
    /**
     * Sets the grantSponsor value for this P.
     * 
     * @param grantSponsor
     */
        ...
        _equals = true && 
            ...
            ((this.contractSponsor==null && other.getContractSponsor()==null) || 
             (this.contractSponsor!=null &&
              this.contractSponsor.equals(other.getContractSponsor()))) &&
            ((this.grantNum==null && other.getGrantNum()==null) || 
             (this.grantNum!=null &&
              this.grantNum.equals(other.getGrantNum()))) &&
            ((this.grantSponsor==null && other.getGrantSponsor()==null) || 
             (this.grantSponsor!=null &&
              this.grantSponsor.equals(other.getGrantSponsor()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getContractSponsor() != null) {
            _hashCode += getContractSponsor().hashCode();
        }
        if (getGrantNum() != null) {
            _hashCode += getGrantNum().hashCode();
        }
        if (getGrantSponsor() != null) {
            _hashCode += getGrantSponsor().hashCode();
        }
        if (getDefList() != null) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch_pmc", ">p"));
