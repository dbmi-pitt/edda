...
public class QueryField  implements java.io.Serializable {
    ...
    /**
     * Gets the sort value for this QueryField.
     * 
     * @return sort
     */
    ...
    /**
     * Sets the sort value for this QueryField.
     * 
     * @param sort
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://woksearchlite.cxf.wokmws.thomsonreuters.com", "queryField"));
