...
public class QueryParameters  implements java.io.Serializable {
    ...
    private com.thomsonreuters.wokmws.cxf.woksearchlite.EditionDesc[] editions;

    private java.lang.String queryLanguage;

    private java.lang.String symbolicTimeSpan;

    private com.thomsonreuters.wokmws.cxf.woksearchlite.TimeSpan timeSpan;
    ...
    public QueryParameters(
           ...
           com.thomsonreuters.wokmws.cxf.woksearchlite.EditionDesc[] editions,
     ...
     * @return editions
     */
    public com.thomsonreuters.wokmws.cxf.woksearchlite.EditionDesc[] getEditions() {
        return editions;
    }
     ...
     * @param editions
     */
    public void setEditions(com.thomsonreuters.wokmws.cxf.woksearchlite.EditionDesc[] editions) {
        this.editions = editions;
    }

    public com.thomsonreuters.wokmws.cxf.woksearchlite.EditionDesc getEditions(int i) {
        return this.editions[i];
    }

    public void setEditions(int i, com.thomsonreuters.wokmws.cxf.woksearchlite.EditionDesc _value) {
     ...
     * @return timeSpan
     */
    public com.thomsonreuters.wokmws.cxf.woksearchlite.TimeSpan getTimeSpan() {
        return timeSpan;
    }
     ...
     * @param timeSpan
     */
    public void setTimeSpan(com.thomsonreuters.wokmws.cxf.woksearchlite.TimeSpan timeSpan) {
        this.timeSpan = timeSpan;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://woksearchlite.cxf.wokmws.thomsonreuters.com", "queryParameters"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://woksearchlite.cxf.wokmws.thomsonreuters.com", "editionDesc"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://woksearchlite.cxf.wokmws.thomsonreuters.com", "timeSpan"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
