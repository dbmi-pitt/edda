...
public class Type implements java.io.Serializable {
    ...
    // Constructor
    protected Type(org.apache.axis.types.Token value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final org.apache.axis.types.Token _simple = new org.apache.axis.types.Token("simple");
    public static final Type simple = new Type(_simple);
    public org.apache.axis.types.Token getValue() { return _value_;}
    public static Type fromValue(org.apache.axis.types.Token value)
