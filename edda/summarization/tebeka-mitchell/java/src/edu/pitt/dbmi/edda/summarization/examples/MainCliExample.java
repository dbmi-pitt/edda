	...
	public static void useGnuParser(final String[] commandLineArguments) {
		...
		try {
			...
			if (commandLine.hasOption("n")) {
				System.out.println("You selected the number "
	...
	public static void main(final String[] commandLineArguments) {
		...
		if (commandLineArguments.length < 1) {
			...
			printUsage(applicationName + " (Posix)", constructPosixOptions(),
					System.out);
			displayBlankLines(1, System.out);
			printUsage(applicationName + " (Gnu)", constructGnuOptions(),
					System.out);

			displayBlankLines(4, System.out);

			System.out.println("-- HELP --");
			printHelp(constructPosixOptions(), 80, "POSIX HELP",
					"End of POSIX Help", 3, 5, true, System.out);
			displayBlankLines(1, System.out);
			printHelp(constructGnuOptions(), 80, "GNU HELP", "End of GNU Help",
					5, 3, true, System.out);
		}
